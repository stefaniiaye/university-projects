...
CREATE TABLE CLIENT (
    ...
    Contact_number nvarchar2(10)  NOT NULL,
...
INSERT INTO HAIRDRESSER (Hairdresser_ID, Hire_date, Name, Salary, Specialty_ID) VALUES (1, TO_DATE('2022-01-01', 'YYYY-MM-DD'), 'Emma Milestone', 50000, 1);
INSERT INTO HAIRDRESSER (Hairdresser_ID, Hire_date, Name, Salary, Specialty_ID) VALUES (2, TO_DATE('2022-02-15', 'YYYY-MM-DD'), 'David Moa', 55000, 2);
INSERT INTO HAIRDRESSER (Hairdresser_ID, Hire_date, Name, Salary, Specialty_ID) VALUES (3, TO_DATE('2022-03-30', 'YYYY-MM-DD'), 'Olivia Starlight', 52000, 3);
INSERT INTO HAIRDRESSER (Hairdresser_ID, Hire_date, Name, Salary, Specialty_ID) VALUES (4, TO_DATE('2022-01-07', 'YYYY-MM-DD'), 'Lorel Castilio', 60000, 2);
INSERT INTO HAIRDRESSER (Hairdresser_ID, Hire_date, Name, Salary, Specialty_ID) VALUES (5, TO_DATE('2022-07-01', 'YYYY-MM-DD'), 'Frida Kitting', 57000, 1);

-- Insert statements for APPOINTMENT table
INSERT INTO APPOINTMENT (Appointment_ID, ADate, Hairdresser_ID, Client_ID) VALUES (1, TO_DATE('2022-04-10', 'YYYY-MM-DD'), 1, 1);
INSERT INTO APPOINTMENT (Appointment_ID, ADate, Hairdresser_ID, Client_ID) VALUES (2, TO_DATE('2022-05-15', 'YYYY-MM-DD'), 2, 2);
INSERT INTO APPOINTMENT (Appointment_ID, ADate, Hairdresser_ID, Client_ID) VALUES (3, TO_DATE('2022-06-20', 'YYYY-MM-DD'), 3, 3);
INSERT INTO APPOINTMENT (Appointment_ID, ADate, Hairdresser_ID, Client_ID) VALUES (4, TO_DATE('2022-07-05', 'YYYY-MM-DD'), 4, 4);
INSERT INTO APPOINTMENT (Appointment_ID, ADate, Hairdresser_ID, Client_ID) VALUES (5, TO_DATE('2022-08-15', 'YYYY-MM-DD'), 5, 5);
INSERT INTO APPOINTMENT (Appointment_ID, ADate, Hairdresser_ID, Client_ID) VALUES (6, TO_DATE('2022-09-20', 'YYYY-MM-DD'), 1, 6);
INSERT INTO APPOINTMENT (Appointment_ID, ADate, Hairdresser_ID, Client_ID) VALUES (7, TO_DATE('2022-10-10', 'YYYY-MM-DD'), 2, 7);
INSERT INTO APPOINTMENT (Appointment_ID, ADate, Hairdresser_ID, Client_ID) VALUES (8, TO_DATE('2022-11-15', 'YYYY-MM-DD'), 3, 8);
INSERT INTO APPOINTMENT (Appointment_ID, ADate, Hairdresser_ID, Client_ID) VALUES (9, TO_DATE('2022-12-20', 'YYYY-MM-DD'), 4, 2);
INSERT INTO APPOINTMENT (Appointment_ID, ADate, Hairdresser_ID, Client_ID) VALUES (10, TO_DATE('2023-01-05', 'YYYY-MM-DD'), 5, 3);
